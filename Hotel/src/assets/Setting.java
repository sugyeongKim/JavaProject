...
public class Setting {
	...
	public static Rectangle seat50 = new Rectangle(165, 70, 1368, 686);
	public static Rectangle seatButton = new Rectangle(165, 109, 1368, 686);
	public static Rectangle memberButton = new Rectangle(500, 650, 300,200);
	public static Rectangle moneyButton = new Rectangle(850, 650, 300, 200);
	public static Rectangle staffButton = new Rectangle(1200, 650, 300, 200);
